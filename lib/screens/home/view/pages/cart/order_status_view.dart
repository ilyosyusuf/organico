                  ...
                  children: [
                    ...
                    BorderedContainerWidget(
                      containerChild: ProfileListTileWidget(
                        title: "Free Shipping",
                        leading: LeadingForListTile(leadingChildColor: ColorConst.whiteGreen, leadingChild: IconConst.coupon),
                      ),
                    ),
                    SizedBox(height: context.h * 0.03),
                        ...
                        return Column(
                          children: [
                            Row(
                              ...
                              children: [
                                Text(data.totalNames[i], style: i== 3 ? FStyles.headline4s : FStyles.headline5main),
                                Text(data.totalCosts[i], style: i== 3 ? FStyles.headline4s : FStyles.headline5main),
                    ...
                    ElevatedButtonWidget(
                      ...
                      width: context.w,
                      child: Text("Order again"), onPressed: (){}),
                    SizedBox(height: context.h * 0.03),
                    ElevatedButtonWidget(
                      height: context.h * 0.06,
                      width: context.w,
                      ...
                      child: Text("Rate Now", style: TextStyle(color: ColorConst.kPrimaryColor),), onPressed: (){})
                  ],
                ),
              ),
            ),
